...
```
Docker can avoid the software installation. You can use the docker image on any system. PhytoPipe docker image usage is in the [docke README (https://hub.docker.com/r/xhu556/phytopipe).
